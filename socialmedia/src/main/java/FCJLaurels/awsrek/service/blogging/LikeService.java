...
public interface LikeService {
    ...
    Optional<LikeDTO> toggleLike(String userId, String blogId);

    // Convert entity to DTO
    LikeDTO convertToDTO(FCJLaurels.awsrek.model.like like);

    // Convert DTO to entity
    FCJLaurels.awsrek.model.like convertToEntity(LikeCreationDTO likeCreationDTO);
}
